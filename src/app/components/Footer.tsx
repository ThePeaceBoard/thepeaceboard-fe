...
const Footer: React.FC = () => {
  return (
    <footer className="flex items-center justify-between font-bebas bg-white w-full px-8 py-12 border-t border-gray-200">
        ...
        <div className="flex flex-row gap-3 items-center">
          ...
          <div className="w-40">
            <a 
              ...
              className="buymecoffee-button block w-full h-11 flex items-center justify-center rounded-lg" 
              style={{backgroundColor: '#FADD4B'}}
            >
              <img src="https://cdn.buymeacoffee.com/buttons/v2/default-yellow.png" alt="Buy Me A Coffee" style={{height: '36px', width: 'auto'}} />
            </a>
          </div>

          {/* Kickstarter */}
          <div className="kickstarter-button-wrapper w-40 h-11 flex items-center justify-center cursor-pointer">
            <svg width="140" height="16" viewBox="0 0 181 20" xmlns="http://www.w3.org/2000/svg" aria-label="Kickstarter">
          ...
          <div className="w-40">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="patreon-button w-full h-11 inline-flex items-center justify-center"
            >
              <FontAwesomeIcon icon={faPatreon} className="text-xl"/>
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-col items-end">
        ...
        <div className="flex gap-3 items-center">
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="social-icon w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors"
          >
            <FontAwesomeIcon icon={faGithub} className="text-gray-700 text-lg"/>
          </a>
          ...
          <a 
            ...
            className="social-icon w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors"
          >
            <FontAwesomeIcon icon={faDiscord} className="text-blue-500 text-lg"/>
          </a>
          ...
          <a 
            href="https://tiktok.com/@saharbarak" 
            target="_blank" 
            rel="noopener noreferrer"
            className="social-icon w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors"
          >
            <FontAwesomeIcon icon={faTiktok} className="text-black text-lg"/>
          </a>
          
          <a 
            href="https://instagram.com/saharbarak" 
            target="_blank" 
            rel="noopener noreferrer"
            className="social-icon w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors"
          >
          ...
          <a 
            ...
            className="social-icon w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors"
          >
            <FontAwesomeIcon icon={faLinkedin} className="text-blue-600 text-lg"/>
          </a>
        </div>
      </div>
    </footer>
